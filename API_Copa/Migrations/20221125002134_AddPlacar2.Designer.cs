...
namespace API_Copa.Migrations
{
    ...
    [Migration("20221125002134_AddPlacar2")]
    partial class AddPlacar2
    {
            ...
            modelBuilder.Entity("API_Copa.Models.Jogo", b =>
                {
                    ...
                    b.Property<int?>("valorAId")
                        .HasColumnType("INTEGER");

                    b.Property<int?>("valorBId")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("API_Copa.Models.Jogo", b =>
                {
                    ...
                    b.HasOne("API_Copa.Models.Selecao", "valorA")
                        .WithMany()
                        .HasForeignKey("valorAId");

                    b.HasOne("API_Copa.Models.Selecao", "valorB")
                        .WithMany()
                        .HasForeignKey("valorBId");
