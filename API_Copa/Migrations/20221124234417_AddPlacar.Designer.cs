...
namespace API_Copa.Migrations
{
    ...
    [Migration("20221124234417_AddPlacar")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API_Copa.Models.Jogo", b =>
                {
                    ...
                    b.Property<int?>("PlacarAId")
                        .HasColumnType("INTEGER");

                    b.Property<int?>("PlacarBId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("PlacarAId");

                    b.HasIndex("PlacarBId");
            ...
            modelBuilder.Entity("API_Copa.Models.Jogo", b =>
                {
                    b.HasOne("API_Copa.Models.Selecao", "PlacarA")
                        .WithMany()
                        .HasForeignKey("PlacarAId");

                    b.HasOne("API_Copa.Models.Selecao", "PlacarB")
                        .WithMany()
                        .HasForeignKey("PlacarBId");
                    ...
                    b.Navigation("PlacarA");

                    b.Navigation("PlacarB");
